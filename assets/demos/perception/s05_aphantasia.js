  ...
  states: [
    ...
    function (ctx) {
      ctx.set(`
        ...
        <div id="aphFoot">
          <div class="step body" style="color:var(--text-secondary)">我属于右边这 3–4%。</div>
          <div class="step small faint" style="margin-top:var(--space-xs)">心盲症（Aphantasia）</div>
        </div>
      `);
    ...
    function (ctx) {
      ctx.set(`
        <h2 class="title center anim fade" style="--d:0s;max-width:70vw">同一个世界，不同的大脑，给出不同的世界。<br>那么 —— 那个「在心里」感受着这一切的东西，究竟在哪里？</h2>
      `);
    },
